...
DocMeta.setdocmeta!(KrakenFortran, :DocTestSetup, :(using KrakenFortran); recursive = true)
...
makedocs(;
    modules = [KrakenFortran],
    authors = "Ariel Vardi <vardister@proton.me>",
    repo = "https://github.com/vardister/KrakenFortran.jl/blob/{commit}{path}#{line}",
    sitename = "KrakenFortran.jl",
    format = Documenter.HTML(; canonical = "https://vardister.github.io/KrakenFortran.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/vardister/KrakenFortran.jl")
